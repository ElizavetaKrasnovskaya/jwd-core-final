...
public class MissionServiceImpl implements MissionService{
    ...
    public List<FlightMission> findAllMissionsByCriteria(Criteria<? extends FlightMission> criteria) {
        ...
        return flightMissions.stream().filter(flightMission -> (
                (flightMission.getName().equals(flightMissionCriteria.getName()) || flightMissionCriteria.getName() == null)
                        && (flightMissionCriteria.getDistance().equals(flightMission.getDistance()) || flightMissionCriteria.getDistance() == null)
                        && (flightMissionCriteria.getStartDate().equals(flightMission.getStartDate()) || flightMissionCriteria.getStartDate() == null)
